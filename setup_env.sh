#!/usr/bin/env bash
# ============================================================
#  FlashAudio — One-Command Environment Setup
# ============================================================
#
...
echo "=============================================="
echo "  FlashAudio Environment Setup"
echo "=============================================="
echo ""
...
echo ""
echo "Installing FlashAudio..."
pip install -e ".[all]" --quiet
echo "[OK] FlashAudio installed"
...
python -c "
import sys, torch, torchaudio, transformers, numpy, librosa
...
echo "    flashaudio transcribe --audio recording.wav"
echo ""
echo "  Text-to-speech:"
echo "    flashaudio speak --text \"Hello world\" --output hello.wav"
echo ""
