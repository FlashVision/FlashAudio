...
Allows registering and discovering models, pipelines, datasets, and tasks
by name — so users can swap them via config without modifying source code.

Usage:
    from flashaudio.registry import MODELS, PIPELINES, DATASETS

    @MODELS.register("WhisperSTT")
    class WhisperSTT:
        ...

    model = MODELS.build("WhisperSTT", **kwargs)
"""
